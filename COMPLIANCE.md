...
> Engineering/product reference, not legal advice. Platform policy pages change often —
> re-verify on a schedule and version the ruleset (see policy #8 below).

## The landscape (2026)

- **FTC (US):** No law requires a generic "this is AI" label. The violations are *deception* —
  fake reviewers/testimonials, AI personas posing as **real** customers, fabricated endorsements,
